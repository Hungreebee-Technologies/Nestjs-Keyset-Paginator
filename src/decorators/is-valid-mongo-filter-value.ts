...
import { ENUM_FILTER_OPERATOR_TYPE, TYPE_STRING_NUM_ARRAY } from '../common.types'
...
export const IsValidMongoFilterValue = (validationOptions?: ValidationOptions) => {
    return function (object: any, propertyName: string) {
        registerDecorator({
            ...
            options: {
                message: 'value must be string or number and string only if operator value is regex',
                ...validationOptions
            },
            validator: {
